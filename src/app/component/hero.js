  ...
  return (
    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        ...
        <p class="mb-8 leading-relaxed">Keys to Inclusion" is more than just a musical performance — it’s a heartfelt mission led by a young pianist turning melodies into impact. Every note she plays helps raise funds to support children with learning challenges. Join her in creating a world where every voice is heard, and no child is left behind.</p>
