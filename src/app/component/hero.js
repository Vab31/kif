  ...
  return (
    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        <h1 class="title-font sm:text-5xl text-3xl mb-4 font-extrabold text-amber-600">Keys to Inclusion
          <br class="hidden lg:inline-block"/><span className='sm:text-3xl text-xl'> A Fun-Raising Program for Empowering Every Voice</span>
        </h1>
